...
namespace Astro
{
    class SlavAstronomy
    {
        ...
        public static (string, string, double, string) ChertogPos(double deg)
        {

            string sunToday, zal, rune;
            double zalRatio;
            if (deg < 22.68)
            {
                sunToday = "Лисы";
            ...
            return (sunToday, zal, zalRatio, rune);
        }
    }

    #region Basic Static Astro Library
    /// <summary>
